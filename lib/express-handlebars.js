...
ExpressHandlebars.prototype._compileTemplate = function (template, options, filePath) {
    // File path can be use to hook in another action according to the path.
    // For example you could compile a markdown templates to html before passing
    // it back to handlebars.
